...
function addFlatDirToRootBuildGradle(buildGradle) {
  ...
  const flatDirCode = `
  flatDir {
    // Point directly to the local module's AARs
    dirs new File(rootDir, '../node_modules/@rarimo/rarime-rn-sdk/android/libs')
 }
  `;

  if (buildGradle.includes('dirs new File(rootDir, \'../node_modules/@rarimo/rarime-rn-sdk/android/libs\')')) {
    return buildGradle;
  }
